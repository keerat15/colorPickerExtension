...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function GiveMeteChild(color, msg) {
        ...
        if (tab.url === undefined || tab.url.indexOf('chrome') == 0) {
            ...
            button.addEventListener("click", () => {
                if (!window.EyeDropper) {
                    GiveMeteChild("#ad5049", 'Your browser does not support the EyeDropper API')
                    return
                }
        ...
        if (resp.color_hex_code && resp.color_hex_code.length > 0) {
            resp.color_hex_code.forEach(hexCode => {
                ...
                liElem.addEventListener("click", () => {
                    ...
                    GiveMeteChild("#161615", "Hex code is copied to clipboard!")
                })
